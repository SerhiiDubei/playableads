...
| M-03 | Доля `groups`/`flow` (НЕ мертві — юзаються games/recipes). Рішення: **лишити паралельними**, задокументувати межу | P2 | #modularity | Med | 0.5h | — | **done** (`docs/SYSTEMS.md`) |
| M-04 | Уніфікувати ігри під контракт шаблонів | P3 | #modularity | Low | 2h | — | **deferred** (рішення M-03: лишаємо паралельними поки) |
