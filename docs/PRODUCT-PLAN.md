...
| **PRE-2** | T-01 — стандарт шаблону заповнено | визначення+manifest+структура+вигляд-по-архетипах+ворота ✅ | — | **done** |
| **PRE-3** | Список must-have механік v1 (чернетка) | `MECHANICS-v1.md`: 14 механік + архетипи/екрани ✅ (чекає твого фіналу) | — | **done** |
